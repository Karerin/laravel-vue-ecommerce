...
//                        'images' => [$product->image]
    ...
    {
        //in creating webhook you need to make sure that you time zone is correct
        // webhook is responsible if the user pay thru stripe and the user suddenly closes the website
        // or having power interruption and the success page is not yet called then the payment is done
        // in stripe website monitoring page will say it is paid while on your created website the payment is pending
        // webhook will prevent that from happening
